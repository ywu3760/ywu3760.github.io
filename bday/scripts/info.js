const INFO = {
    ...
    "aquarius": {
        ...
        "activity": "fun with friends, helping others, fighting for causes, intellectual conversation, a good listener",
    ...
    "pisces": {
        ...
        "activity": "being alone, sleeping, music, romance, visual media, swimming, spiritual themes",
    ...
    "aries": {
        ...
        "activity": "comfortable clothes, taking on leadership roles, physical challenges, individual sports",
    ...
    "taurus": {
        ...
        "activity": "gardening, cooking, music, romance, high quality clothes, working with hands",
    ...
    "gemini": {
        ...
        "activity": "music, books, magazines, chats with nearly anyone, short trips around the town",
    ...
    "cancer": {
        ...
        "activity": "art, home-based hobbies, relaxing near or in water, helping loved ones, a good meal with friends",
    ...
    "leo": {
        ...
        "activity": "theater, taking holidays, being admired, expensive things, bright colors, fun with friends",
    ...
    "virgo": {
        ...
        "activity": "animals, healthy food, books, nature, cleanliness",
    ...
    "libra": {
        ...
        "activity": "harmony, gentleness, sharing with others, the outdoors",
    ...
    "scorpio": {
        ...
        "activity": "truth, facts, being right, longtime friends, teasing, a grand passion",
    ...
    "sagittarius": {
        ...
        "activity": "freedom, travel, philosophy, being outdoors",
    ...
    "capricorn": {
        ...
        "activity": "family, tradition, music, understated status, quality craftsmanship",
